    ...
    <>
      <Suspense fallback={<LoadingSpinner />}>
        <Routes>
          ...
          {/* Pump Installation */}
          <Route path="/pump-installation" element={<PumpInstallationIndex />}>
          ...
          {/* Drill Permits */}
          <Route path="/drill-permits" element={<DrillPermitIndex />}>
          ...
          {/* Water Storage */}
          <Route path="/water-storage" element={<WaterStorageIndex />}>
